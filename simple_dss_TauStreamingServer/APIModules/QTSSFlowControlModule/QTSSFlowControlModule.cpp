...
FileName:	 QTSSFlowControlModule.cpp
...
#define FLOW_CONTROL_DEBUGGING 1
...
// 搭建3个角色,在RTPStream字典中增加3个静态属性,设置模块名称
...
//设置静态对象Message,服务器对象,错误日志流,获取模块预设值,并读取预设值
...
//先读取QTSSFlowControlModule模块的预设值,在读取服务器预设值中的PrefsDisableThinning参数(??xml中没有)
...
QTSS_Error ProcessRTCPPacket(QTSS_RTCPProcess_Params* inParams)
{
    ...
    //ALGORITHM FOR DETERMINING WHEN TO MAKE QUALITY ADJUSTMENTS IN THE STREAM:确定何时对RTPStream对质量调整的算法
